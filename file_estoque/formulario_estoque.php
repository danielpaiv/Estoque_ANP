...
<body>
    ...
    <button onclick="window.location.href='http://localhost/controle_combustivel/estoque_ANP/file_vendas_anterior.php/formulario_vendas_dia_anterior.php'">Listar Vendas Anterior</button>
